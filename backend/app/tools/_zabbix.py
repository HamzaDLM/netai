...
@tool(name="zabbix.get_known_devices")
...
@tool(name="zabbix.get_host_status")
def get_host_status(
...
@tool(name="zabbix.get_host_inventory")
...
@tool(name="zabbix.get_host_interfaces")
...
@tool(name="zabbix.get_host_metrics")
...
@tool(name="zabbix.get_trigger_events")
...
@tool(name="zabbix.get_problem_summary")
