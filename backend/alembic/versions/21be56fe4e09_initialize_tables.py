...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('success', 'error', name='toolcallstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['message_id'], ['message.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    with op.batch_alter_table('toolcall', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_toolcall_message_id'), ['message_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['tool_call_id'], ['toolcall.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('evidence', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_evidence_tool_call_id'), ['tool_call_id'], unique=False)
