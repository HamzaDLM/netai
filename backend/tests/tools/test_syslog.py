from app.tools._syslog_tool_mock import get_syslog_logs
...
def test_get_syslog_logs_filters_by_hostname() -> None:
    payload = _invoke_tool(get_syslog_logs, hostname="dist-rtr-nyc-01")
...
def test_get_syslog_logs_filters_by_optional_severity() -> None:
    payload = _invoke_tool(get_syslog_logs, hostname="dist-rtr-nyc-01", severity=3)
...
def test_get_syslog_logs_returns_error_for_invalid_severity() -> None:
    payload = _invoke_tool(get_syslog_logs, hostname="dist-rtr-nyc-01", severity=99)
