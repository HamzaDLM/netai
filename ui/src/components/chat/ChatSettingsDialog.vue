    ...
    <Dialog>
        <DialogTrigger as-child>
            <button
                :class="[
                    props.iconOnly
                        ? 'flex items-center justify-center transition text-stone-300 hover:bg-stone-900/60'
                        : 'flex items-center gap-2 px-3 py-2 text-sm text-left transition border rounded-md w-min border-stone-800 text-stone-200 hover:border-stone-600 hover:bg-stone-900/60',
                    props.triggerClass,
                ]"
                :title="props.title"
                :aria-label="props.ariaLabel">
                <svg xmlns="http://www.w3.org/2000/svg" :class="props.iconOnly ? 'w-5 h-5' : 'w-4 h-4'" viewBox="0 0 24 24">
                ...
                <span v-if="!props.iconOnly">Settings</span>
            </button>
        </DialogTrigger>
        <DialogContent
